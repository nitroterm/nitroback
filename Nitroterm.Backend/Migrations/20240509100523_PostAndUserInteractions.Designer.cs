...
namespace Nitroterm.Backend.Migrations
{
    ...
    [Migration("20240509100523_PostAndUserInteractions")]
    partial class PostAndUserInteractions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nitroterm.Backend.Database.Models.Asset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nitroterm.Backend.Database.Models.UserToPostInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserToPostInteractions");
                });
            ...
            modelBuilder.Entity("Nitroterm.Backend.Database.Models.User", b =>
                {
                    ...
                    b.HasOne("Nitroterm.Backend.Database.Models.Asset", "ProfilePicture")
                        .WithMany()
            ...
            modelBuilder.Entity("Nitroterm.Backend.Database.Models.UserToPostInteraction", b =>
                {
                    ...
                    b.HasOne("Nitroterm.Backend.Database.Models.User", "SourceUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Nitroterm.Backend.Database.Models.UserToUserInteraction", b =>
                {
                    ...
                    b.HasOne("Nitroterm.Backend.Database.Models.User", "TargetUser")
                        .WithMany()
